...
const target = process.argv[2],
    ...
    referer = fs.readFileSync("ref.txt", 'utf-8').toString().match(/\S+/g),
    license = fs.readFileSync("key.txt", 'utf-8').toString().match(/\S+/g),
    rps = process.argv[5];
...
if (cluster.isMaster) {
    ...
    for (var bb = 0; bb < thread; bb++) {
        console.log("[BUILDING THREADS] => ", bb)
